		...
		<div class="row">
			...
			<div class="col-md-4">
				<form  class="form-search" action="GoodAction1!searchgood">  
					<input type="text" class="input-medium search-query" name="good.name">  
					<button type="submit" class="btn"><span class="glyphicon glyphicon-search"></span></button>  
				</form>
			</div>
			<div class="col-md-4">
				<div id="cart"><a class="btn btn-1" href="ShoppingCarAction!getgoodfromcar"><span class="glyphicon glyphicon-shopping-cart"></span>CART : ${sessionScope.caritem} ITEM</a></div>
			</div>
		</div>
	</header>
	<!--Navigation-->
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse navbar-ex1-collapse">
				<ul class="nav navbar-nav">
					...
					<li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">电子产品</a>
				...
				<div class="col-lg-12">
					...
					<div class="products">
						<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
							<div class="product">
								<div class="image"><a href="GoodAction1!getsinglegood?good.id=1"><img src="images/smartisan.jpg" /></a></div>
								<div class="buttons">
								...
								<div class="caption">
									<div class="name"><h3><a href="GoodAction1!getsinglegood?good.id=1">Smartisan T1</a></h3></div>
									<div class="price">$2480
									<!-- <span>$3000</span> -->
									</div>
						...
						<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
							<div class="product">
								<div class="image"><a href="GoodAction1!getsinglegood?good.id=2"><img src="images/iphone_6.jpg" /></a></div>
								<div class="buttons">
									<a class="btn cart" href="#"><span class="glyphicon glyphicon-shopping-cart"></span></a>
									<a class="btn wishlist" href="#"><span class="glyphicon glyphicon-heart"></span></a>
									<a class="btn compare" href="#"><span class="glyphicon glyphicon-transfer"></span></a>
								...
								<div class="caption">
									<div class="name"><h3><a href="GoodAction1!getsinglegood?good.id=2">Iphone 6</a></h3></div>
						...
						<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
							<div class="product">
								<div class="image"><a href="GoodAction1!getsinglegood?good.id=3"><img src="images/iphone_6s.jpg" /></a></div>
								<div class="buttons">
									<a class="btn cart" href="#"><span class="glyphicon glyphicon-shopping-cart"></span></a>
									<a class="btn wishlist" href="#"><span class="glyphicon glyphicon-heart"></span></a>
									<a class="btn compare" href="#"><span class="glyphicon glyphicon-transfer"></span></a>
								...
								<div class="caption">
									<div class="name"><h3><a href="GoodAction1!getsinglegood?good.id=3">Iphone_6s</a></h3></div>
						...
						<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
							<div class="product">
								<div class="image"><a href="GoodAction1!getsinglegood?good.id=7"><img src="images/xiaomi5.jpg" /></a></div>
								<div class="buttons">
									<a class="btn cart" href="#"><span class="glyphicon glyphicon-shopping-cart"></span></a>
									<a class="btn wishlist" href="#"><span class="glyphicon glyphicon-heart"></span></a>
									<a class="btn compare" href="#"><span class="glyphicon glyphicon-transfer"></span></a>
								...
								<div class="caption">
									<div class="name"><h3><a href="GoodAction1!getsinglegood?good.id=7">小米5</a></h3></div>
									<div class="price">￥2000<span>$98</span></div>
			...
			<div class="row">
				<div class="col-lg-12">
					...
					<div class="products">
						<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
							<div class="product">
								<div class="image"><a href="GoodAction1!getsinglegood?good.id=8"><img src="images/surface_pro4.jpg" /></a></div>
								<div class="buttons">
									<a class="btn cart" href="#"><span class="glyphicon glyphicon-shopping-cart"></span></a>
									<a class="btn wishlist" href="#"><span class="glyphicon glyphicon-heart"></span></a>
									<a class="btn compare" href="#"><span class="glyphicon glyphicon-transfer"></span></a>
								...
								<div class="caption">
									<div class="name"><h3><a href="GoodAction1!getsinglegood?good.id=8">Surface Pro 4</a></h3></div>
									<div class="price">￥6288<span></span></div>
									<div class="rating"><span class="glyphicon glyphicon-star"></span><span class="glyphicon glyphicon-star"></span><span class="glyphicon glyphicon-star"></span><span class="glyphicon glyphicon-star"></span><span class="glyphicon glyphicon-star-empty"></span></div>
								</div>
							</div>
						</div>
						<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
							<div class="product">
								<div class="image"><a href="GoodAction1!getsinglegood?good.id=4"><img src="images/e450.jpg" /></a></div>
								<div class="buttons">
									<a class="btn cart" href="#"><span class="glyphicon glyphicon-shopping-cart"></span></a>
									<a class="btn wishlist" href="#"><span class="glyphicon glyphicon-heart"></span></a>
									<a class="btn compare" href="#"><span class="glyphicon glyphicon-transfer"></span></a>
								...
								<div class="caption">
									<div class="name"><h3><a href="GoodAction1!getsinglegood?good.id=4">ThinkPad E450</a></h3></div>
									<div class="price">￥6000<span></span></div>
									<div class="rating"><span class="glyphicon glyphicon-star"></span><span class="glyphicon glyphicon-star"></span><span class="glyphicon glyphicon-star"></span><span class="glyphicon glyphicon-star-empty"></span><span class="glyphicon glyphicon-star-empty"></span></div>
								</div>
							</div>
						</div>
						<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
							<div class="product">
								<div class="image"><a href="GoodAction1!getsinglegood?good.id=5"><img src="images/macbook.jpg" /></a></div>
								<div class="buttons">
									<a class="btn cart" href="#"><span class="glyphicon glyphicon-shopping-cart"></span></a>
									<a class="btn wishlist" href="#"><span class="glyphicon glyphicon-heart"></span></a>
									<a class="btn compare" href="#"><span class="glyphicon glyphicon-transfer"></span></a>
								...
								<div class="caption">
									<div class="name"><h3><a href="GoodAction1!getsinglegood?good.id=5">MacBook</a></h3></div>
									<div class="price">￥7000<span></span></div>
									<div class="rating"><span class="glyphicon glyphicon-star"></span><span class="glyphicon glyphicon-star"></span><span class="glyphicon glyphicon-star-empty"></span><span class="glyphicon glyphicon-star-empty"></span><span class="glyphicon glyphicon-star-empty"></span></div>
								</div>
							</div>
						</div>
						<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
							<div class="product">
								<div class="image"><a href="GoodAction1!getsinglegood?good.id=6"><img src="images/ipad_air2.jpg" /></a></div>
								<div class="buttons">
									<a class="btn cart" href="#"><span class="glyphicon glyphicon-shopping-cart"></span></a>
									<a class="btn wishlist" href="#"><span class="glyphicon glyphicon-heart"></span></a>
									<a class="btn compare" href="#"><span class="glyphicon glyphicon-transfer"></span></a>
								...
								<div class="caption">
									<div class="name"><h3><a href="GoodAction1!getsinglegood?good.id=6">Ipad Air 2</a></h3></div>
									<div class="price">￥2480<span></span></div>
									<div class="rating"><span class="glyphicon glyphicon-star"></span><span class="glyphicon glyphicon-star"></span><span class="glyphicon glyphicon-star"></span><span class="glyphicon glyphicon-star"></span><span class="glyphicon glyphicon-star"></span></div>
								</div>
							</div>
						</div>
