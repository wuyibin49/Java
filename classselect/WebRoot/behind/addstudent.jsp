  ...
  <body>
     <div class="page">
        ...
        <div class="MainContainer">
			...
			<form action="register!addstudent" method="post">
				<table >
						<tr><td colspan="2" align="center">新增学生</td></tr>
						 ...
						 <td align="center"><input type="text" name ="name" size="40"></td>
						  ...
						  <td align="center"><input type="text" name="snumber" size="40"></td>
						  </tr>
						  <tr>
						 ...
						 <td align="center"> <input type="text" name ="age" size="40"> </td>
						  </tr>
						  <tr>
						 <td width="150px" align="center">出生日期</td>
						 <td align="center"> <input type="text" name ="birthday" size="40"> </td>
						  </tr>
						   <tr >
