...
<head>
	...
	<script type="text/javascript">
		...
		function getjson(){			
			var url="GoodAction!getsinglegood";
			var data=	"good.id=1";
			var price="123";
			$.ajax({
				type:"post",
				url:"GoodAction!getsingle",
				data:"good.id=1",
				datatype:"json",
				success:function(json){
					var good=JSON.parse(json);
					alert(good.price);
				}
			})
			//alert(price);
		...
		var href1;
		$(function (){
			//var href=$('.well a').attr('href');
			//alert($('#pcount'));
			var value;
			
			value=$('#pcount').val();
				href1="GoodAction!addgoodtocar?good.id=${requestScope.goods.id}&good.amout="+$('#pcount').val();
			//alert(href1);
				//$('.well a').attr('href',href1);
			$('#pcount').bind('input propertychange',function(){
				value=$('#pcount').val();
				href1="GoodAction!addgoodtocar?good.id=${requestScope.goods.id}&good.amout="+$('#pcount').val();
			//alert(href1);
				//$('.well a').attr('href',href1);
			...
			<div class="row">
				<div class="col-lg-12">
					<ul class="breadcrumb">
						...
						<li><a href="#">${requestScope.goods.name}</a></li>
					</ul>
				</div>
			</div>
			<div class="row">
				<div id="main-content" class="col-md-8">
					<div class="product">
						<div class="col-md-6">
							<div class="image">
								<img src="images/${good.id}.jpg" />
								<div class="image-more">
									 <ul class="row">
										 <li class="col-lg-3 col-sm-3 col-xs-4">
											<a href="#"><img class="img-responsive" src="images/${good.id}.jpg"></a>
										</li>
										 <li class="col-lg-3 col-sm-3 col-xs-4">
											<a href="#"><img class="img-responsive" src="images/${good.id}.jpg"></a>
										</li>
						...
						<div class="col-md-6">
							<div class="caption">
								<div class="name"><h3>${requestScope.goods.name}</h3></div>
								<div class="info">
									<ul>
										
									</ul>
								</div>
								<div class="price">${requestScope.goods.price}<span>$3000</span></div>
								<div class="options">
									AVAILABLE OPTIONS
									<select>
								...
								<div class="well" ><label>Qty: </label> <input class="form-inline quantity"  id="pcount" type="text" value="1"><a  class="btn btn-2 " onclick="addorder()">ADD</a></div>
				...
				<div id="sidebar" class="col-md-4">
					...
					<div class="widget wid-discouts">
						...
						<div class="content">
							<label class="checkbox"><input type="checkbox" name="discount" checked="checked">Upto - 10% (20)</label>
