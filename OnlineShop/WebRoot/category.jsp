...
<body>
	...
	<header class="container">
		<div class="row">
			...
			<div class="col-md-4">
				<div id="cart"><a class="btn btn-1" href="cart.jsp"><span class="glyphicon glyphicon-shopping-cart"></span>CART : ${sessionScope.caritem} ITEM</a></div>
			</div>
		</div>
	</header>
	<!--Navigation-->
							...
							<div class="products">
								<c:forEach items="${goodslist}" var="good" varStatus="status">
									<div class="col-lg-4 col-md-4 col-xs-12">
										<div class="product">
											<div class="image"><a href="GoodAction1!getsinglegood?good.id=${good.id}"><img src="images/${good.id}.jpg" /></a></div>
											<div class="buttons">
											...
											<div class="caption">
												<div class="name"><h3><a href="GoodAction1!getsinglegood?good.id=${good.id}">${good.name}</a></h3></div>
