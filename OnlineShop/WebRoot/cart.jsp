...
<head>
	...
	function updategood(filed,url){
			var amout=$(filed).parent().children('input').val();
			//alert(amout);
			var url1=url+amout;
			$.post(url1);
		}
		...
		<div class="container">
			...
			<div class="row">
				<div class="product well">
					...
					<div class="col-md-9">
						<div class="caption">
							<div class="name"><h3><a href="GoodAction!getsinglegood?good.id=${good.id}">${good.name}</a></h3></div>
							<div class="info">	
								<ul>
									<li>Brand: text</li>
									<li>ID: 0122222</li>
							...
							<div class="price">￥ ${good.price}<span></span></div>
							<label>Qty: </label> <input class="form-inline quantity" type="text"   value="${good.amout}"><a class="btn btn-2 " onclick="updategood(this,'ShoppingCarAction!updategood?good.id=${good.id}&good.amout=')">Update</a>
							<hr>
							<a href="GoodAction!deletegoodfromcar?good.id=${good.id}" class="btn btn-default pull-right">REMOVE</a>
						</div>
					</div>
					<div class="clear"></div>
				</div>	
			...
			<div class="row">
				<div class="pricedetails">
					<div class="col-md-4 col-md-offset-8">
						...
						<center><a href="OrderAction!addOrder" class="btn btn-1">Checkout</a></center>
					</div>
				</div>
			</div>
		</div>
